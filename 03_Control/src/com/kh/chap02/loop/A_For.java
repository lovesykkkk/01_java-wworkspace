...
public class A_For {
	...
	public void method4() {
		...
		*/
		...
		for(int i =1; i<=10 ;i++) {// i값이 1에서부터 10까지 매번 1씩 증가되는 동안 반복 수행(10
			if(i % 2 == 1) {
				System.out.print(i + " ");
			}
		}
	...
	public void method12() {
		...
		// 다른숫자를 입력했을 경우 : 2~9 사이의 숫자를 입력해야됩니다. 잘못입력해썽
	...
	public void method13() {
		...
		int dan = (int)(Math.random() * 8 + 2); //2가 시작수 , 시작수로 부터 몇개의 랜덤값 발생시킬래?
				 // 0.0 <=   < 1.0 
				 // 0.0 <=   < 8.0
				 // 2.0 <=   < 10.0
				//    2 <=   < 10		=> 2 ~ 9
