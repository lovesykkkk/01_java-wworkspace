...
public class C_StringTokenizerTest {
	...
	public void method() {
		...
		*/
		...
		// i=0 j<6 true 출력("JAVA") i++
		// i=1 j<5 true 출력("Oracle") i++
		// i=2 j<4 true 출력("JDBC") i++
		// i=3 j<3 false --> 반복분 끝나버림
		
		/*
		// 해결방법1.
		int count1 = stn.countTokens(); // count : 6
		...
		*/
		...
		// 해결방법2.
		while(stn.hasMoreTokens()) {//반복이수행될조건 : 토큰이 남아있을때만 출력
			System.out.println(stn.nextToken());
		}
