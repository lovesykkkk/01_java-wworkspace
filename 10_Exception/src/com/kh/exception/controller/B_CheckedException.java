...
public class B_CheckedException {
	 ...
	 * => 조건문 미리제시할 수 없음(왜? 예측이 불가한 곳에서 문제가 발생하기 때문에 미리 예외처리 구문을 작성해놓아야 함)
	...
	public void method2() throws IOException{ // throws 이따가
		...
		*/
		...
		// 2. throws : 지금 이 자리에서 예외를 처리하지 않고 현재 이 메소드 호출하는 곳으로 예외처리 떠넘기겠다. (위임)
	 ...
	 *   CheckedException	RuntimeException외	컴파일에러(빨간줄)		필수(조건문 안됨!! 무조건 예외처리구문으로)
	 * 
	 */
