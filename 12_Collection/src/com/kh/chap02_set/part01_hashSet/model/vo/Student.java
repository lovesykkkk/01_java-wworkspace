...
public class Student {
	...
	public int hashCode() { // 모든 필드에 담긴 값이 일치하면 동일한 hashCode 반환 하도록
		...
		return str.hashCode(); // 이미 String 클래스에서 재정의해둔 hashCode()
	}
	
	@Override
	public boolean equals(Object obj) { // 현재객체와 전달받은 객체의 각 필드값들이 모두 일치하면 true , 하나라도 일치하지않으면 false 반환
		//		this(현객체)		vs		obj(전달받은객체)
		//		Student타입				Object타입
		
		Student other = (Student)obj; // 비교하기 위해 Student로 타입 맞춰주자
