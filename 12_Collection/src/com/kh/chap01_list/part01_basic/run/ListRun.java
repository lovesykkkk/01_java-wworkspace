...
public class ListRun {
	 ...
	 *   - 프레임워크 : 이미 만들어져있는 틀(뼈대) => 그냥 가져다 쓰면됨
	 *   
	 * * 배열의 단점과 컬렉션의 장점
	 * > 배열의 단점
	...
	public static void main(String[] args) {
		//  별도로 제네릭 설정을 하지 않으면 <Object> => 이따가 제네릭 할때 
		ArrayList/*<Object>*/ list = new ArrayList(3); // 크기 지정 할수도 있고 안할수도 있음!! 안하면 기본크기 10
		...
		System.out.println(((Music)list.get(1)).getTitle()); //Object 타입이기 때문에 강제형변환 해줘야한다.
		
		// 7. subList(inte index1, int index2) : List => 추출해서 새로운 List 반환 : substring 같은거
		List sub = list.subList(0, 2); // 반환형 List이기 때문 // 0 <=  < 2
