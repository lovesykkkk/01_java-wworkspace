...
public class InheritRun /*extends Object*/ {
	...
	public static void main(String[] args) {
		 ...
		 * - 명시되어있진 않지만 모든 클래스(제공하는 클래스, 직접만드는 클래스)는 Object 클래스의 후손이다.
		 *   => 즉, Object 클래스에 있는 메소드를 마음대로 호출 가능
		 *   => 뿐만 아니라 오버라이딩을 통해서 재정의도 가능함!!!
		 */

		System.out.println(c.hashCode());
		System.out.println(c.equals(s)); // 그럼 부모가 2명인가요? 아님.. 그림설명
		System.out.println(c/*.toString()*/);
		System.out.println(c.toString()); // 그래서 오버라이딩 나옴 자동완성할때
