...
public class EasyRun {
	...
	//  부모          자식	
		 ...
		 * 			 런타임시점(실행시점)에서는 동적바인딩으로 각각의 자식 클래스에 오버라이딩 된 메소드가 있을 경우 그거 실행됨
		 * 
		 */
		 ...
		 * 	 언제사용되나요??
		 * 
		 * 	 > 개념적 : 단지 이 클래스가 미완성된 클래스다 라는걸 부여할 목적 => 덜만들었을때
		 * 	 > 프로그래밍적 : 객체 생성이 불가 하게끔 하고자 할 때  => 비클을 추상클로 만들어보기
		 * 
